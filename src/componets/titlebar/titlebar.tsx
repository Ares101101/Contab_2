...
function TitleBar({funct}:{funct:() => void}) {
  ...
  return (
    <header data-tauri-drag-region className="h-full relative headerTitle flex items-center justify-center Pro-Light bg-[#e5e5e5ff] border-[#c0c0c0] border-b z-10 ">
      <nav className="flex h-9 justify-start items-center  text-[#333333] p-0 m-0 absolute left-0">
        ...
        <a
          className="cursor-pointer px-2 hover:bg-[#c0c0c0ff] rounded-md h-6 grid items-center" 
          onClick={onSect}
        >
          <p className="Pro-Light  select-none text-sm relative ">Facturacion</p>
        </a>
        <a className="cursor-pointer px-2 hover:bg-[#c0c0c0ff] rounded-md h-6 grid items-center">
      ...
      <button className="Pro-Light  select-none text-sm border border-[#c0c0c0] bg-[#e5e5e5ff]  h-7 hover:bg-[#c0c0c0ff] rounded-md px-2 min-w-64 w-full max-w-96 justify-center items-center flex gap-2">
      ...
      <section className=" h-full w-36 absolute grid grid-cols-3 right-0">
        <button className=" grid items-center justify-center hover:bg-[#c0c0c0ff]" onClick={minimize}><MinimizeIcon className=" w-[9px]"/></button>
        <button className=" grid items-center justify-center hover:bg-[#c0c0c0ff]" onClick={maximize}><MaximiIcon className=" w-[9px]"/></button>
